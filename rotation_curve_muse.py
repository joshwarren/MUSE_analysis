...
def rotation_curve(galaxy, opt='kin', D=None):
	...
	galaxy_file = '%s/Data/muse/analysis/galaxies.txt' % (cc.base_dir)
	galaxy_file2 = '%s/Data/muse/analysis/galaxies2.txt' % (cc.base_dir)
	galaxy_gals = np.loadtxt(galaxy_file, skiprows=1, unpack=True, usecols=(0,), 
		dtype=str)
	x_gals, y_gals = np.loadtxt(galaxy_file, skiprows=1, unpack=True, usecols=(1,2), 
		dtype=int)
...
if __name__=='__main__':
	...
	rotation_curve('ngc1399', opt='kin')