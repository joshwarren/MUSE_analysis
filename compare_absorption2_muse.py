...
if __name__=='__main__':
	...
	plt.legend(facecolor='w',bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
	fig.savefig('%s/Data/lit_absorption/comparison_to_Rampazzo_muse.png' % (
		cc.base_dir))